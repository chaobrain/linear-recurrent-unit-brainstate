# LRU (Linear Recurrent Unit) Implementation in `brainstate`

[![License](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

This repository is an unofficial JAX + [brainstate](https://github.com/chaobrain/brainstate) implementation of the Linear Recurrent Unit (LRU) paper:
