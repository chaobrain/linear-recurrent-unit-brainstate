...
from lru.dataloaders.basic import CIFAR10, MNIST
from lru.dataloaders.copy import CopyTask
from lru.dataloaders.lra import IMDB, ListOps, PathFinder, AAN
...
def make_data_loader(
    ...
    return torch.utils.data.DataLoader(
        ...
        drop_last=drop_last,
        generator=rng,
        num_workers=8 if platform.system() != "Windows" else 0,
    )
